...
console.log('Stripe key found:', stripeSecret.substring(0, 15) + '...');
...
Deno.serve(async (req) => {
  try {
    ...
    if (!customer || !customer.customer_id) {
      ...
      console.log(`Attempting to save customer mapping: user_id=${user.id}, customer_id=${newCustomer.id}`);
      ...
      if (createCustomerError) {
        ...
        console.error('Error details:', JSON.stringify(createCustomerError, null, 2));
