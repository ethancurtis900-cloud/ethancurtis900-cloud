...
export function Testimonials() {
  return (
    <section id="testimonials" className="py-8 sm:py-16 md:py-20 bg-gray-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          {quotes.map((item, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl p-8 border border-gray-200 hover:border-emerald-400 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/10 relative"
            >
              <div className="absolute top-8 right-8 text-emerald-400 opacity-20">
                <Quote className="w-12 h-12" />
              </div>

              <p className="text-gray-700 leading-relaxed mb-6 relative z-10 text-lg font-medium">
                "{item.quote}"
              </p>
