        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 p-8 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2">Built with Passion</h3>
                  <p className="text-navy-300">Every project is a labor of love</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-navy-900/50 backdrop-blur-sm border border-emerald-500/10 rounded-2xl p-8 hover:border-emerald-500/30 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-4">Specialist Focus</h3>
          ...
          <div className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 rounded-3xl p-12 text-center">
            <div className="max-w-3xl mx-auto">
              <div className="grid grid-cols-3 gap-8 mb-12">
                <div>
                  ...
                  <div className="text-navy-300 font-medium">Local Businesses Launched</div>
                </div>
                <div>
                  <div className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400 mb-2">
                    3.2x
                  </div>
                  <div className="text-navy-300 font-medium">Average ROI (90 days)</div>
                </div>
                <div>
                  <div className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400 mb-2">
                    7-Day
                  </div>
                  <div className="text-navy-300 font-medium">Average Delivery</div>
                </div>
              </div>
